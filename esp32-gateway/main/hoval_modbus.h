...
/* Schreibzugriff von innen (MQTT-Kommando): derselbe Pruefpfad wie FC6/FC16 (Freigabe, Whitelist,
 * Kalt-Cache, min/max, Rate-Limit, Kanal-Exklusion). true = auf den CAN gesendet, Spiegel aktualisiert. */
